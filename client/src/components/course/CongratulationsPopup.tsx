    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-2xl max-w-md w-full mx-auto shadow-2xl transform transition-all">
        ...
        <div className="text-center p-8 pb-6">
          ...
          {certificate && (
            <div className="bg-gradient-to-br from-[#41ADE1]/20 via-indigo-50 to-purple-50 border-2 border-[#41ADE1]/40 rounded-xl p-6 mb-6 shadow-lg relative overflow-hidden">
              {/* Background decoration */}
              <div className="absolute top-0 right-0 w-20 h-20 bg-[#41ADE1]/30 rounded-full -translate-y-10 translate-x-10 opacity-30"></div>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center mb-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-[#41ADE1] to-indigo-600 rounded-full flex items-center justify-center shadow-lg">
                ...
                <div className="text-center">
                  ...
                  <div className="bg-gray-800 rounded-lg p-4 border border-gray-600 shadow-sm">
                    ...
                    <div className="font-mono text-sm font-bold text-[#3399CC] bg-[#41ADE1]/20 px-3 py-2 rounded border">
        ...
        <div className="px-8 pb-8 space-y-3">
          {certificate && (
            <button
              ...
              className="w-full bg-gradient-to-r from-[#41ADE1] to-indigo-600 hover:from-[#3399CC] hover:to-indigo-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
